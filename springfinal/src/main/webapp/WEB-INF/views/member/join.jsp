...
<link href="${pageContext.request.contextPath}/css/misolayout.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/css/miso.css"
	rel="stylesheet">
...
.btn-join {
	pointer-events: none;
	opacity: 0.5; /* 또는 다른 값을 사용하여 투명도 조절 가능 */
}
</style>
</head>
<body>
						...
						<div class="row">
							<div class="col">
								...
								<form action="./join" method="post">
											...
											<div class="input-group has-validation">
												<div class="form-floating">
													...
													<input type="text" class="form-control" name="memberPw"
														...
														<div class="feedback gray d-pw-feedback">영어와 숫자로 이루어진 글자 8글자 이상 적어주세요</div>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row mt-3">
										<div class="col">
											<div class="input-group has-validation">
												...
												<button class="btn btn-primary justify-content-end email-check">인증번호 발송</button>
									...
									<div class="input-group has-validation">
									  <div class="form-floating">
									    <input type="text" class="form-control" id="checkNumber" placeholder="인증번호" required>
											...
											<div class="input-group has-validation">
												<div class="form-floating">
													<input type="text" class="form-control"
														name="memberContact" id="memberContect" placeholder="연락처"
														required> <label for="memberContect">연락처</label>
												</div>
											</div>
